...
public class AluminumCableBlockEntity extends BlockEntity implements EnergyProvider {
    ...
    public AluminumCableBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.ALUMINUM_CABLE_BLOCK_ENTITY, pos, state);
    }
    ...
    public static void tick(ServerWorld world, BlockPos pos, BlockState state, AluminumCableBlockEntity entity) {
        ...
        for (Direction dir : Direction.values()) {
            ...
            if (neighbor instanceof EnergyProvider provider && neighbor != entity) {
                ...
                if (storage != null && storage.canInsert() && storage.getEnergy() < storage.getMaxEnergy()) {
                    if (neighbor instanceof AluminumCableBlockEntity || neighbor instanceof CopperCableBlockEntity) {
