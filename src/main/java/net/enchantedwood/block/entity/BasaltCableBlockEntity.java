...
public class BasaltCableBlockEntity extends BlockEntity implements EnergyProvider {
    ...
    public static void tick(ServerWorld world, BlockPos pos, BlockState state, BasaltCableBlockEntity entity) {
        boolean dirty = false;
