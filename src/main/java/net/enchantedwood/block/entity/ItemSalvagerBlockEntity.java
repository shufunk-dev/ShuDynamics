...
public class ItemSalvagerBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, SidedInventory, EnergyProvider {
    ...
    private static void registerModTechAndLogisticsRecipes() {
        ...
        registerRecipe(net.enchantedwood.item.ModItems.SPEED_SERVO_MODULE, 1, 200, new ItemStack(net.enchantedwood.item.ModItems.STEEL_INGOT, 4), new ItemStack(net.enchantedwood.item.ModItems.ALUMINUM_GEAR, 2), new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1));
        registerRecipe(net.enchantedwood.item.ModItems.STEP_ASSIST_MODULE, 1, 200, new ItemStack(net.enchantedwood.item.ModItems.TITANIUM_INGOT, 3), new ItemStack(net.enchantedwood.item.ModItems.STEEL_GEAR, 1), new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1));
    ...
    private static void registerModMachineAndAnchorRecipes() {
        ...
        // Computer Chips
        registerRecipe(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1, 140, new ItemStack(net.enchantedwood.item.ModItems.SILICON_WAFER, 1), new ItemStack(Items.COPPER_INGOT, 2), new ItemStack(Items.REDSTONE, 2), new ItemStack(Items.GOLD_NUGGET, 2));
        registerRecipe(net.enchantedwood.item.ModItems.ADVANCED_COMPUTER_CHIP, 1, 180, new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1), new ItemStack(Items.DIAMOND, 1), new ItemStack(Items.LAPIS_LAZULI, 2), new ItemStack(Items.GLOWSTONE_DUST, 2));
        registerRecipe(net.enchantedwood.item.ModItems.QUANTUM_COMPUTER_CHIP, 1, 260, new ItemStack(net.enchantedwood.item.ModItems.ADVANCED_COMPUTER_CHIP, 1), new ItemStack(net.enchantedwood.item.ModItems.NEODYMIUM_MAGNET, 1), new ItemStack(Items.QUARTZ, 2));

        // Modular Power Armor
        registerRecipe(net.enchantedwood.item.ModItems.MODULAR_POWER_HELMET, 1, 240, new ItemStack(net.enchantedwood.item.ModItems.TITANIUM_INGOT, 4), new ItemStack(net.enchantedwood.item.ModItems.STEEL_INGOT, 1), new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1));
        registerRecipe(net.enchantedwood.item.ModItems.MODULAR_POWER_CHESTPLATE, 1, 300, new ItemStack(net.enchantedwood.item.ModItems.TITANIUM_INGOT, 7), new ItemStack(net.enchantedwood.item.ModItems.STEEL_INGOT, 1), new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1));
        registerRecipe(net.enchantedwood.item.ModItems.MODULAR_POWER_LEGGINGS, 1, 280, new ItemStack(net.enchantedwood.item.ModItems.TITANIUM_INGOT, 6), new ItemStack(net.enchantedwood.item.ModItems.STEEL_INGOT, 1), new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1));
        registerRecipe(net.enchantedwood.item.ModItems.MODULAR_POWER_BOOTS, 1, 220, new ItemStack(net.enchantedwood.item.ModItems.TITANIUM_INGOT, 3), new ItemStack(net.enchantedwood.item.ModItems.STEEL_INGOT, 1), new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1));

        // Power Suit Modules & Repair Matrices
        registerRecipe(net.enchantedwood.item.ModItems.NANITE_REPAIR_MATRIX, 1, 200, new ItemStack(net.enchantedwood.item.ModItems.TITANIUM_INGOT, 4), new ItemStack(net.enchantedwood.item.ModItems.SILICON_WAFER, 2), new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1), new ItemStack(Items.REDSTONE, 2));
        registerRecipe(net.enchantedwood.item.ModItems.HYDROGEN_THRUSTER_MODULE, 1, 220, new ItemStack(net.enchantedwood.item.ModItems.TITANIUM_INGOT, 4), new ItemStack(net.enchantedwood.item.ModItems.HYDROGEN_JETPACK, 1), new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1));
        registerRecipe(net.enchantedwood.item.ModItems.ION_REPULSOR_MODULE, 1, 280, new ItemStack(net.enchantedwood.item.ModItems.NEO_TITANIUM_INGOT, 4), new ItemStack(net.enchantedwood.item.ModItems.NEODYMIUM_MAGNET, 2), new ItemStack(net.enchantedwood.item.ModItems.ADVANCED_COMPUTER_CHIP, 1));
        registerRecipe(net.enchantedwood.item.ModItems.NIGHT_VISION_MODULE, 1, 180, new ItemStack(net.enchantedwood.item.ModItems.TITANIUM_INGOT, 2), new ItemStack(Items.GOLDEN_CARROT, 2), new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1));
        registerRecipe(net.enchantedwood.item.ModItems.SPEED_SERVO_MODULE, 1, 180, new ItemStack(net.enchantedwood.item.ModItems.TITANIUM_INGOT, 4), new ItemStack(Items.SUGAR, 2), new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1));
        registerRecipe(net.enchantedwood.item.ModItems.STEP_ASSIST_MODULE, 1, 180, new ItemStack(net.enchantedwood.item.ModItems.TITANIUM_INGOT, 4), new ItemStack(Items.PISTON, 2), new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1));
        registerRecipe(net.enchantedwood.item.ModItems.HIGH_JUMP_MODULE, 1, 180, new ItemStack(net.enchantedwood.item.ModItems.TITANIUM_INGOT, 4), new ItemStack(Items.SLIME_BALL, 2), new ItemStack(net.enchantedwood.item.ModItems.BASIC_COMPUTER_CHIP, 1));
