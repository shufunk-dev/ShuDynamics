...
public class CopperGeneratorBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, SidedInventory, EnergyProvider {
    ...
    public Text getDisplayName() {
        return Text.translatable("container.enchantedwood.copper_generator");
    }
    ...
    public static void tick(ServerWorld world, BlockPos pos, BlockState state, CopperGeneratorBlockEntity entity) {
        ...
        if (originallyBurning != isBurningNow) {
            state = state.with(CopperGeneratorBlock.LIT, isBurningNow);
