...
import net.enchantedwood.block.entity.CopperCableBlockEntity;
import net.enchantedwood.block.entity.ModBlockEntities;
import net.enchantedwood.energy.EnergyProvider;
import org.jetbrains.annotations.Nullable;

public class CopperCableBlock extends BlockWithEntity {
    public static final MapCodec<CopperCableBlock> CODEC = createCodec(CopperCableBlock::new);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        if (world instanceof ServerWorld serverWorld && type == ModBlockEntities.COPPER_CABLE_BLOCK_ENTITY) {
            return (w, pos, st, blockEntity) -> CopperCableBlockEntity.tick(serverWorld, pos, st, (CopperCableBlockEntity) blockEntity);
        }
        return null;
    }
