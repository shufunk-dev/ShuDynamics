...
import net.enchantedwood.block.entity.AluminumCableBlockEntity;
import net.enchantedwood.block.entity.ModBlockEntities;
import net.enchantedwood.energy.EnergyProvider;
import org.jetbrains.annotations.Nullable;

public class AluminumCableBlock extends BlockWithEntity {
    public static final MapCodec<AluminumCableBlock> CODEC = createCodec(AluminumCableBlock::new);
    ...
    public AluminumCableBlock(Settings settings) {
        super(settings);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        if (world instanceof ServerWorld serverWorld && type == ModBlockEntities.ALUMINUM_CABLE_BLOCK_ENTITY) {
            return (w, pos, st, blockEntity) -> AluminumCableBlockEntity.tick(serverWorld, pos, st, (AluminumCableBlockEntity) blockEntity);
        }
        return null;
    }
