...
import net.enchantedwood.block.entity.BasaltCableBlockEntity;
import net.enchantedwood.energy.EnergyProvider;
import org.jetbrains.annotations.Nullable;

public class BasaltCableBlock extends BlockWithEntity {
    public static final MapCodec<BasaltCableBlock> CODEC = createCodec(BasaltCableBlock::new);
    ...
    public BasaltCableBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new BasaltCableBlockEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        if (world instanceof ServerWorld serverWorld && type == ModBlockEntities.BASALT_CABLE_BE) {
            return (w, pos, st, blockEntity) -> BasaltCableBlockEntity.tick(serverWorld, pos, st, (BasaltCableBlockEntity) blockEntity);
        }
        return null;
    }
    ...
    public boolean canConnectTo(BlockView world, BlockPos pos, Direction direction) {
        ...
        if (neighborState.getBlock() instanceof BasaltCableBlock ||
