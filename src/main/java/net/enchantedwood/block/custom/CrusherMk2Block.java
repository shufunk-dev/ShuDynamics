...
public class CrusherMk2Block extends BlockWithEntity {
    public static final MapCodec<CrusherMk2Block> CODEC = createCodec(CrusherMk2Block::new);
    public static final EnumProperty<Direction> FACING = Properties.HORIZONTAL_FACING;
    public static final BooleanProperty LIT = Properties.LIT;

    public CrusherMk2Block(Settings settings) {
        super(settings);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        if (world instanceof ServerWorld serverWorld && type == ModBlockEntities.CRUSHER_MK2_BE) {
