...
public class AsphaltRampBlock extends HorizontalFacingBlock {
    public static final MapCodec<AsphaltRampBlock> CODEC = createCodec(AsphaltRampBlock::new);
    ...
    public AsphaltRampBlock(Settings settings) {
        super(settings);
