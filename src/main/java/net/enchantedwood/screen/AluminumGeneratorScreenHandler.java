...
public class AluminumGeneratorScreenHandler extends ScreenHandler {
    ...
    public int getBurnTime() { return this.propertyDelegate.get(4); }
    public int getTotalBurnTime() { return this.propertyDelegate.get(5); }
    public int getGenerationRate() { return this.propertyDelegate.get(6); }
