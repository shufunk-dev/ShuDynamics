...
public class SoilInfuserScreen extends HandledScreen<SoilInfuserScreenHandler> {
    private static final Identifier GUI_TEXTURE = Identifier.of(EnchantedWoodMod.MOD_ID, "textures/gui/container/soil_infuser_gui.png");

    public SoilInfuserScreen(SoilInfuserScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        // 2. Infusion Progress Arrow at x + 86, y + 34 (width 24, height 17)
        int cookWidth = this.handler.getScaledCookProgress(24);
        if (cookWidth > 0) {
            context.drawTexture(RenderPipelines.GUI_TEXTURED, GUI_TEXTURE, x + 86, y + 34, 176.0f, 14.0f, cookWidth, 17, 256, 256);
        }
    }
