...
[![Latest Release](https://img.shields.io/badge/Release-v2.0.2-purple.svg?style=flat-square)](https://github.com/shufunk-dev/ShuDynamics/releases)
...
* **Airlock Security**: Gowning Door with radar proximity detection, and Decontamination Door with Bunny Suit bio-scanner and automated 3-second pressurized steam wash shower.
...
* **100% Metal Reclaim Ratio**: Returns 100% base metal volume from weapons, armor, tools, and intact or damaged anvils (2,790 mB / full 31 ingots).
...
* **Agricultural Harvesters & Planters**: Reaps mature farmland crops across 3–7 block swaths while immediately replanting seeds into fertile soil.
...
* **Thermal Plasma Flamethrower**: 12-block piercing superheated plasma beam weapon.
...
```text
build/libs/shudynamics-2.0.2.jar
```
