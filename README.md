...
[![Stable Release](https://img.shields.io/badge/Release-v1.5.1-green.svg?style=flat-square)](https://www.curseforge.com/minecraft/mc-mods/shudynamics)
...
```text
build/libs/shudynamics-1.5.1.jar
```
